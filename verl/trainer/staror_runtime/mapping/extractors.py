...
from verl.trainer.staror_runtime.config import DatasetConfig
from verl.trainer.staror_runtime.dataset import build_instance_from_question
from verl.trainer.staror_runtime.types import OptimizationTask
...
class RuleMappingExtractor:
    ...
    def extract(
        ...
        from verl.trainer.staror_runtime.reward.perturbation import build_perturbation_map
