...
from verl.trainer.ttrl_or_runtime.config import DatasetConfig
from verl.trainer.ttrl_or_runtime.dataset import build_instance_from_question
from verl.trainer.ttrl_or_runtime.types import OptimizationTask
...
class RuleMappingExtractor:
    ...
    def extract(
        ...
        from verl.trainer.ttrl_or_runtime.reward.perturbation import build_perturbation_map
