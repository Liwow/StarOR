...
<tests>[{"case_id":"higher_requirements_and_cost_pressure","patches":[{"fid":"F01","new_value":30},{"fid":"F02","new_value":45},{"fid":"F08","new_value":0.25}],"obj_scale":{"kind":"interval","lower":2.1,"upper":3.6,"sign_relation":"positive","magnitude":{"min_order":0,"max_order":1,"use_abs":true},"reject_exact":[0]},"rationale":"Higher vitamin requirements and more expensive One Daily should increase the optimal daily cost."},{"case_id":"milder_requirements_and_cheaper_one_daily","patches":[{"fid":"F01","new_value":22},{"fid":"F02","new_value":36},{"fid":"F08","new_value":0.18}],"obj_scale":{"kind":"interval","lower":1.2,"upper":2.2,"sign_relation":"positive","magnitude":{"min_order":0,"max_order":1,"use_abs":true},"reject_exact":[0]},"rationale":"Lower requirements and cheaper One Daily should reduce total cost while preserving model structure."}]</tests>
...
<tests>[{"case_id":"harder_route_key_edges_up","patches":[{"fid":"F04","new_value":58},{"fid":"F08","new_value":42},{"fid":"F07","new_value":60}],"obj_scale":{"kind":"interval","lower":245,"upper":340,"sign_relation":"positive","magnitude":{"min_order":2,"max_order":3,"use_abs":true},"reject_exact":[0]},"rationale":"Increasing several low-impact bridge edges should push the best Hamiltonian cycle cost upward."},{"case_id":"easier_route_key_edges_down","patches":[{"fid":"F04","new_value":38},{"fid":"F08","new_value":24},{"fid":"F05","new_value":42}],"obj_scale":{"kind":"interval","lower":180,"upper":245,"sign_relation":"positive","magnitude":{"min_order":2,"max_order":3,"use_abs":true},"reject_exact":[0]},"rationale":"Reducing selected key edges should create cheaper tours and lower the optimum."}]</tests>
"""
